...
![Quick Summary: AWS EC2 – Elastic Compute Cloud](../assets/topic-summaries/aws-ec2-compute.svg)

> **⚡ 80/20 Summary:** AMI starts instance • instance type sets capacity • security group controls access • user data bootstraps apps
