...
![Quick Summary: Prometheus Architecture and Monitoring](../assets/topic-summaries/prometheus-architecture-monitoring.svg)

> **⚡ 80/20 Summary:** Targets expose metrics • Prometheus scrapes data • PromQL asks questions • Alertmanager routes alerts
