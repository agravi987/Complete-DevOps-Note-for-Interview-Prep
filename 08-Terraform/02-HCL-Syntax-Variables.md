...
![Quick Summary: Terraform HCL Syntax and Variables](../assets/topic-summaries/terraform-hcl-syntax-variables.svg)

> **⚡ 80/20 Summary:** Variables make code reusable • locals simplify logic • outputs expose values • data sources read existing infra
